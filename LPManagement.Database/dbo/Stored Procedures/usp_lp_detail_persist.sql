DROP PROCEDURE [dbo].[usp_lp_detail_persist]
GO

CREATE PROCEDURE [dbo].[usp_lp_detail_persist]
	@employee_data [dbo].[lp_detail_type] readonly
AS
	MERGE [dbo].[lp_detail] targetTable  
	USING
	(
		SELECT 
			[launch_pad_code]   
